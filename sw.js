const CACHE_NAME = 'airport-direction-training-level4-v12';
const ASSETS=['./','./index.html','./manifest.webmanifest','./airport-icon.png', './apple-touch-icon.png', './icon-192.png', './icon-512.png'];
